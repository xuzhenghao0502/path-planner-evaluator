...
class SpeedOCPModelCost : public CostFunction {
 public:
  SpeedOCPModelCost() : CostFunction(3, 8) {}

  virtual ~SpeedOCPModelCost() = default;
...
template <>
class SpeedOCPModelCost<StageType::TERMINAL> : public CostFunction {
 public:
  SpeedOCPModelCost() : CostFunction(3, 8) {}
  virtual ~SpeedOCPModelCost() = default;
