# SpeedOCPModel user manual

user manual for generated model SpeedOCPModel, code optimization has been applied for the best performance
...
| 10    | -slack_v_upper + v <= VSoftUpperBound                                       |
