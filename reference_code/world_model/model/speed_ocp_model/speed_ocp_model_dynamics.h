...
class SpeedOCPModelDynamics : public Dynamics {
 public:
  explicit SpeedOCPModelDynamics(OcpConfig::IntegratorType type = OcpConfig::ERK4) : Dynamics(3, 8, type) {}
  virtual ~SpeedOCPModelDynamics() = default;
...
class SpeedOCPModelIntegrator : public Integrator {
 public:
  SpeedOCPModelIntegrator(const Dynamics* dynamics) : Integrator(dynamics) {}
  virtual ~SpeedOCPModelIntegrator() = default;
...
template <>
class SpeedOCPModelIntegrator<OcpConfig::ERK4> : public Integrator {
 public:
  SpeedOCPModelIntegrator(const Dynamics* dynamics) : Integrator(dynamics) {}
  virtual ~SpeedOCPModelIntegrator() = default;
