...
class LateralGeneralIpmEvaluator : public IpmEvaluator {
 public:
  LateralGeneralIpmEvaluator() : IpmEvaluator(5, 2, 17, 0, 0) {}
  virtual ~LateralGeneralIpmEvaluator() = default;
  ...
  virtual void updateLX(const Eigen::VectorXd& l_x, const Eigen::MatrixXd& Fx, const Eigen::MatrixXd& g_x, const Eigen::MatrixXd& h_x, const Eigen::MatrixXd& m_x, const Eigen::VectorXd& p, const Eigen::VectorXd& lambda, const Eigen::VectorXd& eta, const Eigen::VectorXd& nu, Eigen::VectorXd& sl_x) const override {
    ...
    sl_x(0) = Fx(0, 0)*p(0);
    sl_x(1) = Fx(0, 1)*p(0) + Fx(1, 1)*p(1) + g_x(0, 1)*lambda(0) + g_x(1, 1)*lambda(1) + g_x(11, 1)*lambda(11) + g_x(12, 1)*lambda(12) + g_x(13, 1)*lambda(13) + g_x(14, 1)*lambda(14) + g_x(15, 1)*lambda(15) + g_x(16, 1)*lambda(16) + g_x(2, 1)*lambda(2) + g_x(3, 1)*lambda(3) + g_x(4, 1)*lambda(4) + g_x(5, 1)*lambda(5) + l_x(1);
    sl_x(2) = Fx(0, 2)*p(0) + Fx(2, 2)*p(2) + g_x(0, 2)*lambda(0) + g_x(1, 2)*lambda(1) + g_x(11, 2)*lambda(11) + g_x(12, 2)*lambda(12) + g_x(13, 2)*lambda(13) + g_x(14, 2)*lambda(14) + g_x(15, 2)*lambda(15) + g_x(16, 2)*lambda(16) + g_x(2, 2)*lambda(2) + g_x(3, 2)*lambda(3) + g_x(4, 2)*lambda(4) + g_x(5, 2)*lambda(5) + l_x(2);
    sl_x(3) = Fx(0, 3)*p(0) + Fx(1, 3)*p(1) + Fx(2, 3)*p(2) + Fx(3, 3)*p(3) + g_x(13, 3)*lambda(13) + g_x(14, 3)*lambda(14) + g_x(15, 3)*lambda(15) + g_x(16, 3)*lambda(16) + g_x(2, 3)*lambda(2) + g_x(3, 3)*lambda(3) + g_x(4, 3)*lambda(4) + g_x(5, 3)*lambda(5) + g_x(8, 3)*lambda(8) + l_x(3);
  ...
  virtual void updateLU(const Eigen::VectorXd& l_u, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& g_u, const Eigen::MatrixXd& h_u, const Eigen::VectorXd& p, const Eigen::VectorXd& lambda, const Eigen::VectorXd& eta, Eigen::VectorXd& sl_u) const override {
    ...
    sl_u(1) = g_u(11, 1)*lambda(11) + g_u(12, 1)*lambda(12) + g_u(13, 1)*lambda(13) + g_u(14, 1)*lambda(14) + g_u(15, 1)*lambda(15) + g_u(16, 1)*lambda(16) + l_u(1);
  ...
  virtual void updateQH(const Eigen::MatrixXd& l_xx, const Eigen::MatrixXd& l_xu, const Eigen::MatrixXd& l_uu, const Eigen::MatrixXd& g_x, const Eigen::MatrixXd& g_u, const Eigen::MatrixXd& Fx, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& V_xx_prev) override {
    ...
    const double internal_10 = Sigma_(11)*g_x(11, 1);
    const double internal_11 = Sigma_(12)*g_x(12, 1);
    const double internal_12 = Sigma_(13)*g_x(13, 1);
    const double internal_13 = Sigma_(14)*g_x(14, 1);
    const double internal_14 = Sigma_(15)*g_x(15, 1);
    const double internal_15 = Sigma_(16)*g_x(16, 1);
    const double internal_16 = Sigma_(2)*g_x(2, 1);
    const double internal_17 = Sigma_(3)*g_x(3, 1);
    const double internal_18 = Sigma_(4)*g_x(4, 1);
    const double internal_19 = Sigma_(5)*g_x(5, 1);
    const double internal_2 = Fx(0, 2)*V_xx_prev(0, 0);
    const double internal_28 = Sigma_(13)*g_x(13, 2);
    const double internal_29 = Sigma_(14)*g_x(14, 2);
    const double internal_3 = Fx(0, 0)*V_xx_prev(0, 2);
    const double internal_30 = Sigma_(15)*g_x(15, 2);
    const double internal_31 = Sigma_(16)*g_x(16, 2);
    ...
    const double internal_21 = Fx(0, 1)*V_xx_prev(0, 3) + Fx(1, 1)*V_xx_prev(1, 3);
    const double internal_23 = Fx(0, 1)*V_xx_prev(0, 4) + Fx(1, 1)*V_xx_prev(1, 4);
    const double internal_25 = Fx(0, 2)*V_xx_prev(0, 1) + Fx(2, 2)*V_xx_prev(2, 1);
    const double internal_26 = Fx(0, 2)*V_xx_prev(0, 2) + Fx(2, 2)*V_xx_prev(2, 2);
    const double internal_27 = Fx(0, 2)*V_xx_prev(0, 3) + Fx(2, 2)*V_xx_prev(2, 3);
    const double internal_33 = Fx(0, 2)*V_xx_prev(0, 4) + Fx(2, 2)*V_xx_prev(2, 4);
    const double internal_35 = Fx(0, 3)*V_xx_prev(0, 1) + Fx(1, 3)*V_xx_prev(1, 1) + Fx(2, 3)*V_xx_prev(2, 1) + Fx(3, 3)*V_xx_prev(3, 1);
    const double internal_36 = Fx(0, 3)*V_xx_prev(0, 2) + Fx(1, 3)*V_xx_prev(1, 2) + Fx(2, 3)*V_xx_prev(2, 2) + Fx(3, 3)*V_xx_prev(3, 2);
    const double internal_37 = Fx(0, 3)*V_xx_prev(0, 3) + Fx(1, 3)*V_xx_prev(1, 3) + Fx(2, 3)*V_xx_prev(2, 3) + Fx(3, 3)*V_xx_prev(3, 3);
    const double internal_38 = Fx(0, 3)*V_xx_prev(0, 4) + Fx(1, 3)*V_xx_prev(1, 4) + Fx(2, 3)*V_xx_prev(2, 4) + Fx(3, 3)*V_xx_prev(3, 4);
    const double internal_39 = Fx(3, 4)*V_xx_prev(3, 0) + Fx(4, 4)*V_xx_prev(4, 0);
    const double internal_40 = Fx(3, 4)*V_xx_prev(3, 1) + Fx(4, 4)*V_xx_prev(4, 1);
    const double internal_41 = Fx(3, 4)*V_xx_prev(3, 2) + Fx(4, 4)*V_xx_prev(4, 2);
    const double internal_42 = Fx(3, 4)*V_xx_prev(3, 3) + Fx(4, 4)*V_xx_prev(4, 3);
    const double internal_43 = Fx(3, 4)*V_xx_prev(3, 4) + Fx(4, 4)*V_xx_prev(4, 4);
    ...
    const double internal_24 = Fx(2, 2)*V_xx_prev(2, 0) + internal_2;
    const double internal_34 = Fx(1, 3)*V_xx_prev(1, 0) + Fx(2, 3)*V_xx_prev(2, 0) + Fx(3, 3)*V_xx_prev(3, 0) + internal_4;
    const double internal_7 = Fx(1, 1)*V_xx_prev(1, 0) + internal_0;
    const double internal_20 = Sigma_(0)*g_x(0, 1)*g_x(0, 2) + Sigma_(1)*g_x(1, 1)*g_x(1, 2) + g_x(11, 2)*internal_10 + g_x(12, 2)*internal_11 + g_x(13, 2)*internal_12 + g_x(14, 2)*internal_13 + g_x(15, 2)*internal_14 + g_x(16, 2)*internal_15 + g_x(2, 2)*internal_16 + g_x(3, 2)*internal_17 + g_x(4, 2)*internal_18 + g_x(5, 2)*internal_19;
    const double internal_22 = g_x(13, 3)*internal_12 + g_x(14, 3)*internal_13 + g_x(15, 3)*internal_14 + g_x(16, 3)*internal_15 + g_x(2, 3)*internal_16 + g_x(3, 3)*internal_17 + g_x(4, 3)*internal_18 + g_x(5, 3)*internal_19;
    const double internal_32 = Sigma_(2)*g_x(2, 2)*g_x(2, 3) + Sigma_(3)*g_x(3, 2)*g_x(3, 3) + Sigma_(4)*g_x(4, 2)*g_x(4, 3) + Sigma_(5)*g_x(5, 2)*g_x(5, 3) + g_x(13, 3)*internal_28 + g_x(14, 3)*internal_29 + g_x(15, 3)*internal_30 + g_x(16, 3)*internal_31;
    ...
    Q_xx_(1, 1) = Fx(0, 1)*internal_7 + Fx(1, 1)*internal_8 + Sigma_(0)*pow(g_x(0, 1), 2) + Sigma_(1)*pow(g_x(1, 1), 2) + Sigma_(11)*pow(g_x(11, 1), 2) + Sigma_(12)*pow(g_x(12, 1), 2) + Sigma_(13)*pow(g_x(13, 1), 2) + Sigma_(14)*pow(g_x(14, 1), 2) + Sigma_(15)*pow(g_x(15, 1), 2) + Sigma_(16)*pow(g_x(16, 1), 2) + Sigma_(2)*pow(g_x(2, 1), 2) + Sigma_(3)*pow(g_x(3, 1), 2) + Sigma_(4)*pow(g_x(4, 1), 2) + Sigma_(5)*pow(g_x(5, 1), 2) + l_xx(1, 1);
    Q_xx_(1, 2) = Fx(0, 2)*internal_7 + Fx(2, 2)*internal_9 + internal_20 + l_xx(1, 2);
    Q_xx_(1, 3) = Fx(0, 3)*internal_7 + Fx(1, 3)*internal_8 + Fx(2, 3)*internal_9 + Fx(3, 3)*internal_21 + internal_22;
    Q_xx_(1, 4) = Fx(3, 4)*internal_21 + Fx(4, 4)*internal_23;
    Q_xx_(2, 0) = Fx(0, 0)*internal_24;
    Q_xx_(2, 1) = Fx(0, 1)*internal_24 + Fx(1, 1)*internal_25 + internal_20 + l_xx(2, 1);
    Q_xx_(2, 2) = Fx(0, 2)*internal_24 + Fx(2, 2)*internal_26 + Sigma_(0)*pow(g_x(0, 2), 2) + Sigma_(1)*pow(g_x(1, 2), 2) + Sigma_(11)*pow(g_x(11, 2), 2) + Sigma_(12)*pow(g_x(12, 2), 2) + Sigma_(13)*pow(g_x(13, 2), 2) + Sigma_(14)*pow(g_x(14, 2), 2) + Sigma_(15)*pow(g_x(15, 2), 2) + Sigma_(16)*pow(g_x(16, 2), 2) + Sigma_(2)*pow(g_x(2, 2), 2) + Sigma_(3)*pow(g_x(3, 2), 2) + Sigma_(4)*pow(g_x(4, 2), 2) + Sigma_(5)*pow(g_x(5, 2), 2) + l_xx(2, 2);
    Q_xx_(2, 3) = Fx(0, 3)*internal_24 + Fx(1, 3)*internal_25 + Fx(2, 3)*internal_26 + Fx(3, 3)*internal_27 + internal_32;
    Q_xx_(2, 4) = Fx(3, 4)*internal_27 + Fx(4, 4)*internal_33;
    Q_xx_(3, 0) = Fx(0, 0)*internal_34;
    Q_xx_(3, 1) = Fx(0, 1)*internal_34 + Fx(1, 1)*internal_35 + internal_22;
    Q_xx_(3, 2) = Fx(0, 2)*internal_34 + Fx(2, 2)*internal_36 + internal_32;
    Q_xx_(3, 3) = Fx(0, 3)*internal_34 + Fx(1, 3)*internal_35 + Fx(2, 3)*internal_36 + Fx(3, 3)*internal_37 + Sigma_(13)*pow(g_x(13, 3), 2) + Sigma_(14)*pow(g_x(14, 3), 2) + Sigma_(15)*pow(g_x(15, 3), 2) + Sigma_(16)*pow(g_x(16, 3), 2) + Sigma_(2)*pow(g_x(2, 3), 2) + Sigma_(3)*pow(g_x(3, 3), 2) + Sigma_(4)*pow(g_x(4, 3), 2) + Sigma_(5)*pow(g_x(5, 3), 2) + Sigma_(8)*pow(g_x(8, 3), 2) + l_xx(3, 3);
    Q_xx_(3, 4) = Fx(3, 4)*internal_37 + Fx(4, 4)*internal_38;
    Q_xx_(4, 0) = Fx(0, 0)*internal_39;
    Q_xx_(4, 1) = Fx(0, 1)*internal_39 + Fx(1, 1)*internal_40;
    Q_xx_(4, 2) = Fx(0, 2)*internal_39 + Fx(2, 2)*internal_41;
    Q_xx_(4, 3) = Fx(0, 3)*internal_39 + Fx(1, 3)*internal_40 + Fx(2, 3)*internal_41 + Fx(3, 3)*internal_42;
    Q_xx_(4, 4) = Fx(3, 4)*internal_42 + Fx(4, 4)*internal_43 + Sigma_(6)*pow(g_x(6, 4), 2) + Sigma_(7)*pow(g_x(7, 4), 2) + l_xx(4, 4);

    // Evaluation of Matrix Q_xu_
    Q_xu_(0, 0) = Fu(4, 0)*internal_6;
    Q_xu_(1, 0) = Fu(4, 0)*internal_23;
    Q_xu_(1, 1) = g_u(11, 1)*internal_10 + g_u(12, 1)*internal_11 + g_u(13, 1)*internal_12 + g_u(14, 1)*internal_13 + g_u(15, 1)*internal_14 + g_u(16, 1)*internal_15;
    Q_xu_(2, 0) = Fu(4, 0)*internal_33;
    Q_xu_(2, 1) = Sigma_(11)*g_u(11, 1)*g_x(11, 2) + Sigma_(12)*g_u(12, 1)*g_x(12, 2) + g_u(13, 1)*internal_28 + g_u(14, 1)*internal_29 + g_u(15, 1)*internal_30 + g_u(16, 1)*internal_31;
    Q_xu_(3, 0) = Fu(4, 0)*internal_38;
    Q_xu_(3, 1) = Sigma_(13)*g_u(13, 1)*g_x(13, 3) + Sigma_(14)*g_u(14, 1)*g_x(14, 3) + Sigma_(15)*g_u(15, 1)*g_x(15, 3) + Sigma_(16)*g_u(16, 1)*g_x(16, 3);
    Q_xu_(4, 0) = Fu(4, 0)*internal_43;

    // Evaluation of Matrix Q_uu_
    Q_uu_(0, 0) = pow(Fu(4, 0), 2)*V_xx_prev(4, 4) + Sigma_(10)*pow(g_u(10, 0), 2) + Sigma_(9)*pow(g_u(9, 0), 2) + l_uu(0, 0);
    Q_uu_(1, 1) = Sigma_(11)*pow(g_u(11, 1), 2) + Sigma_(12)*pow(g_u(12, 1), 2) + Sigma_(13)*pow(g_u(13, 1), 2) + Sigma_(14)*pow(g_u(14, 1), 2) + Sigma_(15)*pow(g_u(15, 1), 2) + Sigma_(16)*pow(g_u(16, 1), 2) + l_uu(1, 1);
  ...
  virtual void updateQG(const Eigen::VectorXd& sl_x, const Eigen::VectorXd& sl_u, const Eigen::MatrixXd& g_x, const Eigen::MatrixXd& g_u, const Eigen::VectorXd& r_f, const Eigen::MatrixXd& Fx, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& V_xx_prev, const Eigen::VectorXd& V_x_prev) override {
    ...
    Q_x_(1) = Fx(0, 1)*internal_0 + Fx(1, 1)*internal_1 + V_(0)*g_x(0, 1) + V_(1)*g_x(1, 1) + V_(11)*g_x(11, 1) + V_(12)*g_x(12, 1) + V_(13)*g_x(13, 1) + V_(14)*g_x(14, 1) + V_(15)*g_x(15, 1) + V_(16)*g_x(16, 1) + V_(2)*g_x(2, 1) + V_(3)*g_x(3, 1) + V_(4)*g_x(4, 1) + V_(5)*g_x(5, 1) + sl_x(1);
    Q_x_(2) = Fx(0, 2)*internal_0 + Fx(2, 2)*internal_2 + V_(0)*g_x(0, 2) + V_(1)*g_x(1, 2) + V_(11)*g_x(11, 2) + V_(12)*g_x(12, 2) + V_(13)*g_x(13, 2) + V_(14)*g_x(14, 2) + V_(15)*g_x(15, 2) + V_(16)*g_x(16, 2) + V_(2)*g_x(2, 2) + V_(3)*g_x(3, 2) + V_(4)*g_x(4, 2) + V_(5)*g_x(5, 2) + sl_x(2);
    Q_x_(3) = Fx(0, 3)*internal_0 + Fx(1, 3)*internal_1 + Fx(2, 3)*internal_2 + Fx(3, 3)*internal_3 + V_(13)*g_x(13, 3) + V_(14)*g_x(14, 3) + V_(15)*g_x(15, 3) + V_(16)*g_x(16, 3) + V_(2)*g_x(2, 3) + V_(3)*g_x(3, 3) + V_(4)*g_x(4, 3) + V_(5)*g_x(5, 3) + V_(8)*g_x(8, 3) + sl_x(3);
    Q_x_(4) = Fx(3, 4)*internal_3 + Fx(4, 4)*internal_4 + V_(6)*g_x(6, 4) + V_(7)*g_x(7, 4) + sl_x(4);

    // Evaluation of Vector Q_u_
    Q_u_(0) = Fu(4, 0)*internal_4 + V_(10)*g_u(10, 0) + V_(9)*g_u(9, 0) + sl_u(0);
    Q_u_(1) = V_(11)*g_u(11, 1) + V_(12)*g_u(12, 1) + V_(13)*g_u(13, 1) + V_(14)*g_u(14, 1) + V_(15)*g_u(15, 1) + V_(16)*g_u(16, 1) + sl_u(1);
...
template <>
class LateralGeneralIpmEvaluator<StageType::INITIAL, OcpConfig::FORWARD_EULER> : public IpmEvaluator {
 public:
  LateralGeneralIpmEvaluator() : IpmEvaluator(5, 2, 2, 0, 5) {}
  virtual ~LateralGeneralIpmEvaluator() = default;
...
template <>
class LateralGeneralIpmEvaluator<StageType::NORMINAL, OcpConfig::ERK4> : public IpmEvaluator {
 public:
  LateralGeneralIpmEvaluator() : IpmEvaluator(5, 2, 17, 0, 0) {}
  virtual ~LateralGeneralIpmEvaluator() = default;
  ...
  virtual void updateLU(const Eigen::VectorXd& l_u, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& g_u, const Eigen::MatrixXd& h_u, const Eigen::VectorXd& p, const Eigen::VectorXd& lambda, const Eigen::VectorXd& eta, Eigen::VectorXd& sl_u) const override {
    // Evaluation of Vector sl_u
    sl_u(0) = Fu(0, 0)*p(0) + Fu(1, 0)*p(1) + Fu(2, 0)*p(2) + Fu(3, 0)*p(3) + Fu(4, 0)*p(4) + g_u(10, 0)*lambda(10) + g_u(9, 0)*lambda(9) + l_u(0);
    sl_u(1) = g_u(11, 1)*lambda(11) + g_u(12, 1)*lambda(12) + g_u(13, 1)*lambda(13) + g_u(14, 1)*lambda(14) + g_u(15, 1)*lambda(15) + g_u(16, 1)*lambda(16) + l_u(1);
  ...
  virtual void updateQH(const Eigen::MatrixXd& l_xx, const Eigen::MatrixXd& l_xu, const Eigen::MatrixXd& l_uu, const Eigen::MatrixXd& g_x, const Eigen::MatrixXd& g_u, const Eigen::MatrixXd& Fx, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& V_xx_prev) override {
    ...
    const double internal_0 = Fx(0, 1)*V_xx_prev(0, 0);
    const double internal_1 = Fx(0, 0)*V_xx_prev(0, 1);
    const double internal_11 = Sigma_(11)*g_x(11, 1);
    const double internal_12 = Sigma_(12)*g_x(12, 1);
    const double internal_13 = Sigma_(13)*g_x(13, 1);
    const double internal_14 = Sigma_(14)*g_x(14, 1);
    const double internal_15 = Sigma_(15)*g_x(15, 1);
    const double internal_16 = Sigma_(16)*g_x(16, 1);
    const double internal_17 = Sigma_(2)*g_x(2, 1);
    const double internal_18 = Sigma_(3)*g_x(3, 1);
    const double internal_19 = Sigma_(4)*g_x(4, 1);
    const double internal_2 = Fx(0, 2)*V_xx_prev(0, 0);
    const double internal_20 = Sigma_(5)*g_x(5, 1);
    const double internal_29 = Sigma_(13)*g_x(13, 2);
    const double internal_3 = Fx(0, 0)*V_xx_prev(0, 2);
    const double internal_30 = Sigma_(14)*g_x(14, 2);
    const double internal_31 = Sigma_(15)*g_x(15, 2);
    const double internal_32 = Sigma_(16)*g_x(16, 2);
    const double internal_4 = Fx(0, 3)*V_xx_prev(0, 0);
    const double internal_45 = Fu(0, 0)*V_xx_prev(0, 0);
    const double internal_5 = Fx(0, 0)*V_xx_prev(0, 3);
    ...
    const double internal_22 = Fx(0, 1)*V_xx_prev(0, 3) + Fx(1, 1)*V_xx_prev(1, 3);
    const double internal_24 = Fx(0, 1)*V_xx_prev(0, 4) + Fx(1, 1)*V_xx_prev(1, 4);
    const double internal_26 = Fx(0, 2)*V_xx_prev(0, 1) + Fx(2, 2)*V_xx_prev(2, 1);
    const double internal_27 = Fx(0, 2)*V_xx_prev(0, 2) + Fx(2, 2)*V_xx_prev(2, 2);
    const double internal_28 = Fx(0, 2)*V_xx_prev(0, 3) + Fx(2, 2)*V_xx_prev(2, 3);
    const double internal_34 = Fx(0, 2)*V_xx_prev(0, 4) + Fx(2, 2)*V_xx_prev(2, 4);
    const double internal_36 = Fx(0, 3)*V_xx_prev(0, 1) + Fx(1, 3)*V_xx_prev(1, 1) + Fx(2, 3)*V_xx_prev(2, 1) + Fx(3, 3)*V_xx_prev(3, 1);
    const double internal_37 = Fx(0, 3)*V_xx_prev(0, 2) + Fx(1, 3)*V_xx_prev(1, 2) + Fx(2, 3)*V_xx_prev(2, 2) + Fx(3, 3)*V_xx_prev(3, 2);
    const double internal_38 = Fx(0, 3)*V_xx_prev(0, 3) + Fx(1, 3)*V_xx_prev(1, 3) + Fx(2, 3)*V_xx_prev(2, 3) + Fx(3, 3)*V_xx_prev(3, 3);
    const double internal_39 = Fx(0, 3)*V_xx_prev(0, 4) + Fx(1, 3)*V_xx_prev(1, 4) + Fx(2, 3)*V_xx_prev(2, 4) + Fx(3, 3)*V_xx_prev(3, 4);
    ...
    const double internal_25 = Fx(2, 2)*V_xx_prev(2, 0) + internal_2;
    const double internal_35 = Fx(1, 3)*V_xx_prev(1, 0) + Fx(2, 3)*V_xx_prev(2, 0) + Fx(3, 3)*V_xx_prev(3, 0) + internal_4;
    ...
    const double internal_21 = Sigma_(0)*g_x(0, 1)*g_x(0, 2) + Sigma_(1)*g_x(1, 1)*g_x(1, 2) + g_x(11, 2)*internal_11 + g_x(12, 2)*internal_12 + g_x(13, 2)*internal_13 + g_x(14, 2)*internal_14 + g_x(15, 2)*internal_15 + g_x(16, 2)*internal_16 + g_x(2, 2)*internal_17 + g_x(3, 2)*internal_18 + g_x(4, 2)*internal_19 + g_x(5, 2)*internal_20;
    const double internal_23 = g_x(13, 3)*internal_13 + g_x(14, 3)*internal_14 + g_x(15, 3)*internal_15 + g_x(16, 3)*internal_16 + g_x(2, 3)*internal_17 + g_x(3, 3)*internal_18 + g_x(4, 3)*internal_19 + g_x(5, 3)*internal_20;
    const double internal_33 = Sigma_(2)*g_x(2, 2)*g_x(2, 3) + Sigma_(3)*g_x(3, 2)*g_x(3, 3) + Sigma_(4)*g_x(4, 2)*g_x(4, 3) + Sigma_(5)*g_x(5, 2)*g_x(5, 3) + g_x(13, 3)*internal_29 + g_x(14, 3)*internal_30 + g_x(15, 3)*internal_31 + g_x(16, 3)*internal_32;
    ...
    Q_xx_(1, 1) = Fx(0, 1)*internal_8 + Fx(1, 1)*internal_9 + Sigma_(0)*pow(g_x(0, 1), 2) + Sigma_(1)*pow(g_x(1, 1), 2) + Sigma_(11)*pow(g_x(11, 1), 2) + Sigma_(12)*pow(g_x(12, 1), 2) + Sigma_(13)*pow(g_x(13, 1), 2) + Sigma_(14)*pow(g_x(14, 1), 2) + Sigma_(15)*pow(g_x(15, 1), 2) + Sigma_(16)*pow(g_x(16, 1), 2) + Sigma_(2)*pow(g_x(2, 1), 2) + Sigma_(3)*pow(g_x(3, 1), 2) + Sigma_(4)*pow(g_x(4, 1), 2) + Sigma_(5)*pow(g_x(5, 1), 2) + l_xx(1, 1);
    Q_xx_(1, 2) = Fx(0, 2)*internal_8 + Fx(2, 2)*internal_10 + internal_21 + l_xx(1, 2);
    Q_xx_(1, 3) = Fx(0, 3)*internal_8 + Fx(1, 3)*internal_9 + Fx(2, 3)*internal_10 + Fx(3, 3)*internal_22 + internal_23;
    Q_xx_(1, 4) = Fx(0, 4)*internal_8 + Fx(1, 4)*internal_9 + Fx(2, 4)*internal_10 + Fx(3, 4)*internal_22 + Fx(4, 4)*internal_24;
    Q_xx_(2, 0) = Fx(0, 0)*internal_25;
    Q_xx_(2, 1) = Fx(0, 1)*internal_25 + Fx(1, 1)*internal_26 + internal_21 + l_xx(2, 1);
    Q_xx_(2, 2) = Fx(0, 2)*internal_25 + Fx(2, 2)*internal_27 + Sigma_(0)*pow(g_x(0, 2), 2) + Sigma_(1)*pow(g_x(1, 2), 2) + Sigma_(11)*pow(g_x(11, 2), 2) + Sigma_(12)*pow(g_x(12, 2), 2) + Sigma_(13)*pow(g_x(13, 2), 2) + Sigma_(14)*pow(g_x(14, 2), 2) + Sigma_(15)*pow(g_x(15, 2), 2) + Sigma_(16)*pow(g_x(16, 2), 2) + Sigma_(2)*pow(g_x(2, 2), 2) + Sigma_(3)*pow(g_x(3, 2), 2) + Sigma_(4)*pow(g_x(4, 2), 2) + Sigma_(5)*pow(g_x(5, 2), 2) + l_xx(2, 2);
    Q_xx_(2, 3) = Fx(0, 3)*internal_25 + Fx(1, 3)*internal_26 + Fx(2, 3)*internal_27 + Fx(3, 3)*internal_28 + internal_33;
    Q_xx_(2, 4) = Fx(0, 4)*internal_25 + Fx(1, 4)*internal_26 + Fx(2, 4)*internal_27 + Fx(3, 4)*internal_28 + Fx(4, 4)*internal_34;
    Q_xx_(3, 0) = Fx(0, 0)*internal_35;
    Q_xx_(3, 1) = Fx(0, 1)*internal_35 + Fx(1, 1)*internal_36 + internal_23;
    Q_xx_(3, 2) = Fx(0, 2)*internal_35 + Fx(2, 2)*internal_37 + internal_33;
    Q_xx_(3, 3) = Fx(0, 3)*internal_35 + Fx(1, 3)*internal_36 + Fx(2, 3)*internal_37 + Fx(3, 3)*internal_38 + Sigma_(13)*pow(g_x(13, 3), 2) + Sigma_(14)*pow(g_x(14, 3), 2) + Sigma_(15)*pow(g_x(15, 3), 2) + Sigma_(16)*pow(g_x(16, 3), 2) + Sigma_(2)*pow(g_x(2, 3), 2) + Sigma_(3)*pow(g_x(3, 3), 2) + Sigma_(4)*pow(g_x(4, 3), 2) + Sigma_(5)*pow(g_x(5, 3), 2) + Sigma_(8)*pow(g_x(8, 3), 2) + l_xx(3, 3);
    Q_xx_(3, 4) = Fx(0, 4)*internal_35 + Fx(1, 4)*internal_36 + Fx(2, 4)*internal_37 + Fx(3, 4)*internal_38 + Fx(4, 4)*internal_39;
    ...
    Q_xx_(4, 4) = Fx(0, 4)*internal_40 + Fx(1, 4)*internal_41 + Fx(2, 4)*internal_42 + Fx(3, 4)*internal_43 + Fx(4, 4)*internal_44 + Sigma_(6)*pow(g_x(6, 4), 2) + Sigma_(7)*pow(g_x(7, 4), 2) + l_xx(4, 4);

    // Evaluation of Matrix Q_xu_
    Q_xu_(0, 0) = Fu(1, 0)*internal_1 + Fu(2, 0)*internal_3 + Fu(3, 0)*internal_5 + Fu(4, 0)*internal_7 + Fx(0, 0)*internal_45;
    Q_xu_(1, 0) = Fu(0, 0)*internal_8 + Fu(1, 0)*internal_9 + Fu(2, 0)*internal_10 + Fu(3, 0)*internal_22 + Fu(4, 0)*internal_24;
    Q_xu_(1, 1) = g_u(11, 1)*internal_11 + g_u(12, 1)*internal_12 + g_u(13, 1)*internal_13 + g_u(14, 1)*internal_14 + g_u(15, 1)*internal_15 + g_u(16, 1)*internal_16;
    Q_xu_(2, 0) = Fu(0, 0)*internal_25 + Fu(1, 0)*internal_26 + Fu(2, 0)*internal_27 + Fu(3, 0)*internal_28 + Fu(4, 0)*internal_34;
    Q_xu_(2, 1) = Sigma_(11)*g_u(11, 1)*g_x(11, 2) + Sigma_(12)*g_u(12, 1)*g_x(12, 2) + g_u(13, 1)*internal_29 + g_u(14, 1)*internal_30 + g_u(15, 1)*internal_31 + g_u(16, 1)*internal_32;
    Q_xu_(3, 0) = Fu(0, 0)*internal_35 + Fu(1, 0)*internal_36 + Fu(2, 0)*internal_37 + Fu(3, 0)*internal_38 + Fu(4, 0)*internal_39;
    Q_xu_(3, 1) = Sigma_(13)*g_u(13, 1)*g_x(13, 3) + Sigma_(14)*g_u(14, 1)*g_x(14, 3) + Sigma_(15)*g_u(15, 1)*g_x(15, 3) + Sigma_(16)*g_u(16, 1)*g_x(16, 3);
    Q_xu_(4, 0) = Fu(0, 0)*internal_40 + Fu(1, 0)*internal_41 + Fu(2, 0)*internal_42 + Fu(3, 0)*internal_43 + Fu(4, 0)*internal_44;

    // Evaluation of Matrix Q_uu_
    Q_uu_(0, 0) = Fu(0, 0)*(Fu(1, 0)*V_xx_prev(1, 0) + Fu(2, 0)*V_xx_prev(2, 0) + Fu(3, 0)*V_xx_prev(3, 0) + Fu(4, 0)*V_xx_prev(4, 0) + internal_45) + Fu(1, 0)*(Fu(0, 0)*V_xx_prev(0, 1) + Fu(1, 0)*V_xx_prev(1, 1) + Fu(2, 0)*V_xx_prev(2, 1) + Fu(3, 0)*V_xx_prev(3, 1) + Fu(4, 0)*V_xx_prev(4, 1)) + Fu(2, 0)*(Fu(0, 0)*V_xx_prev(0, 2) + Fu(1, 0)*V_xx_prev(1, 2) + Fu(2, 0)*V_xx_prev(2, 2) + Fu(3, 0)*V_xx_prev(3, 2) + Fu(4, 0)*V_xx_prev(4, 2)) + Fu(3, 0)*(Fu(0, 0)*V_xx_prev(0, 3) + Fu(1, 0)*V_xx_prev(1, 3) + Fu(2, 0)*V_xx_prev(2, 3) + Fu(3, 0)*V_xx_prev(3, 3) + Fu(4, 0)*V_xx_prev(4, 3)) + Fu(4, 0)*(Fu(0, 0)*V_xx_prev(0, 4) + Fu(1, 0)*V_xx_prev(1, 4) + Fu(2, 0)*V_xx_prev(2, 4) + Fu(3, 0)*V_xx_prev(3, 4) + Fu(4, 0)*V_xx_prev(4, 4)) + Sigma_(10)*pow(g_u(10, 0), 2) + Sigma_(9)*pow(g_u(9, 0), 2) + l_uu(0, 0);
    Q_uu_(1, 1) = Sigma_(11)*pow(g_u(11, 1), 2) + Sigma_(12)*pow(g_u(12, 1), 2) + Sigma_(13)*pow(g_u(13, 1), 2) + Sigma_(14)*pow(g_u(14, 1), 2) + Sigma_(15)*pow(g_u(15, 1), 2) + Sigma_(16)*pow(g_u(16, 1), 2) + l_uu(1, 1);
  ...
  virtual void updateQG(const Eigen::VectorXd& sl_x, const Eigen::VectorXd& sl_u, const Eigen::MatrixXd& g_x, const Eigen::MatrixXd& g_u, const Eigen::VectorXd& r_f, const Eigen::MatrixXd& Fx, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& V_xx_prev, const Eigen::VectorXd& V_x_prev) override {
    ...
    // Evaluation of Vector Q_u_
    Q_u_(0) = Fu(0, 0)*internal_0 + Fu(1, 0)*internal_1 + Fu(2, 0)*internal_2 + Fu(3, 0)*internal_3 + Fu(4, 0)*internal_4 + V_(10)*g_u(10, 0) + V_(9)*g_u(9, 0) + sl_u(0);
    Q_u_(1) = V_(11)*g_u(11, 1) + V_(12)*g_u(12, 1) + V_(13)*g_u(13, 1) + V_(14)*g_u(14, 1) + V_(15)*g_u(15, 1) + V_(16)*g_u(16, 1) + sl_u(1);
...
template <>
class LateralGeneralIpmEvaluator<StageType::INITIAL, OcpConfig::ERK4> : public IpmEvaluator {
 public:
  LateralGeneralIpmEvaluator() : IpmEvaluator(5, 2, 2, 0, 5) {}
  virtual ~LateralGeneralIpmEvaluator() = default;
...
class LateralGeneralIpmEvaluatorTerminal : public IpmEvaluatorTerminal {
 public:
  LateralGeneralIpmEvaluatorTerminal() : IpmEvaluatorTerminal(5, 2, 9, 0) {}
  virtual ~LateralGeneralIpmEvaluatorTerminal() = default;
  ...
  virtual void updateLX(const Eigen::VectorXd& l_x, const Eigen::MatrixXd& g_x, const Eigen::MatrixXd& m_x, const Eigen::VectorXd& p, const Eigen::VectorXd& lambda, const Eigen::VectorXd& nu, Eigen::VectorXd& sl_x) const override {
    ...
    sl_x(3) = g_x(2, 3)*lambda(2) + g_x(3, 3)*lambda(3) + g_x(4, 3)*lambda(4) + g_x(5, 3)*lambda(5) + g_x(8, 3)*lambda(8) + l_x(3) - p(3);
  ...
  virtual void updateVxx(const Eigen::MatrixXd& l_xx, const Eigen::VectorXd& sl_x, const Eigen::MatrixXd& g_x, Eigen::MatrixXd& V_xx, Eigen::VectorXd& V_x) override {
    ...
    V_xx(3, 1) = internal_5;
    V_xx(3, 2) = internal_6;
    V_xx(3, 3) = Sigma_(2)*pow(g_x(2, 3), 2) + Sigma_(3)*pow(g_x(3, 3), 2) + Sigma_(4)*pow(g_x(4, 3), 2) + Sigma_(5)*pow(g_x(5, 3), 2) + Sigma_(8)*pow(g_x(8, 3), 2) + l_xx(3, 3);
    ...
    V_x(3) = V_(2)*g_x(2, 3) + V_(3)*g_x(3, 3) + V_(4)*g_x(4, 3) + V_(5)*g_x(5, 3) + V_(8)*g_x(8, 3) + sl_x(3);
