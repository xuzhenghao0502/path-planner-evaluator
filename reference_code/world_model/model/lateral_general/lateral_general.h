...
#include "lateral_general_cost.h"
#include "lateral_general_constraints.h"
#include "lateral_general_ipm_evaluator.h"

namespace gpal::pnc::planning {

class LateralGeneral : public OptimalControlProblem {
 public:
  LateralGeneral();
  virtual ~LateralGeneral() = default;
