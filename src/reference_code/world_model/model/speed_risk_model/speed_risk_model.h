...
#include "speed_risk_model_constraints.h"
#include "speed_risk_model_cost.h"
#include "speed_risk_model_dynamics.h"
#include "speed_risk_model_ipm_evaluator.h"

namespace gpal::pnc::planning {

class SpeedRiskModel : public OptimalControlProblem {
 public:
  SpeedRiskModel();
  virtual ~SpeedRiskModel() = default;
