...
class LateralMultiGearIpmEvaluator : public IpmEvaluator {
 public:
  LateralMultiGearIpmEvaluator() : IpmEvaluator(4, 1, 4, 0, 0) {}
  virtual ~LateralMultiGearIpmEvaluator() = default;
  ...
  virtual void updateLX(const Eigen::VectorXd& l_x, const Eigen::MatrixXd& Fx, const Eigen::MatrixXd& g_x,
    ...
    sl_x(3) = Fx(2, 3) * p(2) + Fx(3, 3) * p(3) + g_x(0, 3) * lambda(0) + g_x(1, 3) * lambda(1) + l_x(3);
  }
  ...
  virtual void updateLU(const Eigen::VectorXd& l_u, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& g_u,
    ...
    sl_u(0) = Fu(3, 0) * p(3) + g_u(2, 0) * lambda(2) + g_u(3, 0) * lambda(3) + l_u(0);
  }
  ...
  virtual void updateQH(const Eigen::MatrixXd& l_xx, const Eigen::MatrixXd& l_xu, const Eigen::MatrixXd& l_uu,
    ...
    const double g_u_2_0_p2 = g_u(2, 0) * g_u(2, 0);
    ...
    Q_xx_(3, 3) = Fx(2, 3) * (Fx(2, 3) * V_xx_prev(2, 2) + Fx(3, 3) * V_xx_prev(3, 2)) +
                  Fx(3, 3) * (Fx(2, 3) * V_xx_prev(2, 3) + Fx(3, 3) * V_xx_prev(3, 3)) + Sigma_(0) * g_x_0_3_p2 +
                  Sigma_(1) * g_x_1_3_p2 + l_xx(3, 3);
    ...
    Q_uu_(0, 0) = Fu_3_0_p2 * V_xx_prev(3, 3) + Sigma_(2) * g_u_2_0_p2 + Sigma_(3) * g_u_3_0_p2 + l_uu(0, 0);
  }
  ...
  virtual void updateQG(const Eigen::VectorXd& sl_x, const Eigen::VectorXd& sl_u, const Eigen::MatrixXd& g_x,
    ...
    Q_u_(0) = Fu(3, 0) * (V_x_prev(3) + V_xx_prev(3, 0) * r_f(0) + V_xx_prev(3, 1) * r_f(1) + V_xx_prev(3, 2) * r_f(2) +
                          V_xx_prev(3, 3) * r_f(3)) +
              V_(2) * g_u(2, 0) + V_(3) * g_u(3, 0) + sl_u(0);
  }
...
template <>
class LateralMultiGearIpmEvaluator<StageType::INITIAL, OcpConfig::FORWARD_EULER> : public IpmEvaluator {
 public:
  LateralMultiGearIpmEvaluator() : IpmEvaluator(4, 1, 2, 0, 4) {}
  virtual ~LateralMultiGearIpmEvaluator() = default;
...
template <>
class LateralMultiGearIpmEvaluator<StageType::NORMINAL, OcpConfig::ERK4> : public IpmEvaluator {
 public:
  LateralMultiGearIpmEvaluator() : IpmEvaluator(4, 1, 4, 0, 0) {}
  virtual ~LateralMultiGearIpmEvaluator() = default;
  ...
  virtual void updateLU(const Eigen::VectorXd& l_u, const Eigen::MatrixXd& Fu, const Eigen::MatrixXd& g_u,
                        ...
                        const Eigen::VectorXd& eta, Eigen::VectorXd& sl_u) const override {
    // Evaluation of Vector sl_u
    sl_u(0) = Fu(0, 0) * p(0) + Fu(1, 0) * p(1) + Fu(2, 0) * p(2) + Fu(3, 0) * p(3) + g_u(2, 0) * lambda(2) +
              g_u(3, 0) * lambda(3) + l_u(0);
  }
  ...
  virtual void updateQH(const Eigen::MatrixXd& l_xx, const Eigen::MatrixXd& l_xu, const Eigen::MatrixXd& l_uu,
    ...
    Q_uu_(0, 0) = Fu(0, 0) * (Fu(0, 0) * V_xx_prev(0, 0) + Fu(1, 0) * V_xx_prev(1, 0) + Fu(2, 0) * V_xx_prev(2, 0) +
                  ...
                  Sigma_(2) * g_u_2_0_p2 + Sigma_(3) * g_u_3_0_p2 + l_uu(0, 0);
  }
...
template <>
class LateralMultiGearIpmEvaluator<StageType::INITIAL, OcpConfig::ERK4> : public IpmEvaluator {
 public:
  LateralMultiGearIpmEvaluator() : IpmEvaluator(4, 1, 2, 0, 4) {}
  virtual ~LateralMultiGearIpmEvaluator() = default;
...
class LateralMultiGearIpmEvaluatorTerminal : public IpmEvaluatorTerminal {
 public:
  LateralMultiGearIpmEvaluatorTerminal() : IpmEvaluatorTerminal(4, 1, 2, 0) {}
  virtual ~LateralMultiGearIpmEvaluatorTerminal() = default;
  ...
  virtual void updateLX(const Eigen::VectorXd& l_x, const Eigen::MatrixXd& g_x, const Eigen::MatrixXd& m_x,
    ...
    sl_x(1) = l_x(1) - p(1);
    sl_x(2) = l_x(2) - p(2);
    sl_x(3) = g_x(0, 3) * lambda(0) + g_x(1, 3) * lambda(1) - p(3);
  }
  ...
  virtual void updateVxx(const Eigen::MatrixXd& l_xx, const Eigen::VectorXd& sl_x, const Eigen::MatrixXd& g_x,
    ...
    V_xx(1, 1) = l_xx(1, 1);
    V_xx(2, 2) = l_xx(2, 2);
    V_xx(3, 3) = Sigma_(0) * g_x_0_3_p2 + Sigma_(1) * g_x_1_3_p2;
